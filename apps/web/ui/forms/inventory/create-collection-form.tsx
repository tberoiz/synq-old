...
import { createInventoryCollection } from "@synq/supabase/queries/inventory";
...
export const CreateCollectionForm = ({
  ...
  const onSubmit = async (data: InventoryFormValues) => {
    try {
      await createInventoryCollection(data.name, "");
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
        ...
        <DialogFooter>
          ...
          <Button type="submit">Create a new Collection</Button>
        </DialogFooter>
      </form>
    </Form>
  );
